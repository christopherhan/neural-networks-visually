...
for *each* weight, how the loss would change if you nudged it, millions
of weights all feeding that one loss. How can you possibly compute all those slopes without

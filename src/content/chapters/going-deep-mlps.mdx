...
composition usually does more of the work.
...
every draw. Nothing about the math or the architecture changed; the villain
of a decade dissolved because the starting numbers were *chosen carefully*.

...
**XOR wall**, and it is not a toy problem — it once froze the entire field.
...
billions of these together (chapters 6 onward). The figure above runs
exactly this weighted-sum math — and in chapter 4 you'll meet the ~150-line
autograd engine that teaches networks to tune `w` themselves. View source
anytime; the whole engine ships with this site.

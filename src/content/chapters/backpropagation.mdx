...
This isn't pseudocode; it's lightly trimmed from
[`src/lib/nn/value.ts`](https://github.com/christopherhan/neural-networks-visually/blob/main/src/lib/nn/value.ts),
the code that actually ran the figure above. PyTorch and JAX are this exact
idea, plus tensors, plus a decade of engineering.
